...
def train_model(model_params, optimizer_params, training_data,
    ...
    model_path = save_model(model, save_time=save_time, sub_folders=sub_folders)
    history = get_save_history(history, model_params, optimizer_params, model_path, training_time, save_time)
